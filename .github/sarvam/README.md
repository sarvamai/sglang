...
Every six hours, the opt-in workflow checks stable releases of `sgl-project/sglang`.
It mirrors exact upstream commits and opens draft PRs into Sarvam `main`.

- `sglang/main` tracks the newest stable version seen, using fast-forward updates.
...
2. Fix mirror ruleset `22532780` to match `refs/heads/sglang/*`; retain
   deletion and force-push protection. In main ruleset `22534170`, retain PR
